...
- eventlistener 사용 시 내부적으로 this가 바뀐다.<br> 그러나 eventlistener 내부 함수의 this는 window를 가르킨다.<br>
위의 문제를 해결하기 위해 this를 that이라는 새로운 변수에 저장하거나 arrowfunction을 쓴다. arrowfunction은 상위함수의 this를 가져온다.
